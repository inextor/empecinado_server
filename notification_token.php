...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("notification_token");
	}
	...
	{
		return $this->genericInsert($array,"notification_token");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "notification_token", $insert_with_ids );
	}
	...
	function delete()
	{
		try
		{
			return $this->genericDelete("notification_token");
		}
		catch(LoggableException $e)
		{
			DBTable::rollback();
