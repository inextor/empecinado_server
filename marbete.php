...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("marbete");
	}
	...
	{
		return $this->genericInsert($array,"marbete");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "marbete", $insert_with_ids );
	}
	...
	function delete()
	{
		try
		{
			return $this->genericDelete("marbete");
		}
		catch(LoggableException $e)
		{
			DBTable::rollback();
