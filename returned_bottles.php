...
class Service extends SuperRest
{
	function get()
	{
		...
		$extra_sort = array();
		$this->is_debug = true;
		return $this->genericGet("returned_bottles",$extra_constraints,$extra_joins,$extra_sort);
	}
	...
	{
		return $this->genericInsert($array,"returned_bottles");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "returned_bottles", $insert_with_ids );
	}
	...
	function delete()
	{
		try
		{
			return $this->genericDelete("returned_bottles");
		}
		catch(LoggableException $e)
		{
			DBTable::rollback();
